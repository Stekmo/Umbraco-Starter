...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "b7473dfded8a7a2c")]
...
#pragma warning restore 0109
	...
	[PublishedContentModel("articlesContents")]
	public partial class ArticlesContents : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "articlesContents";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public ArticlesContents(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<ArticlesContents, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
